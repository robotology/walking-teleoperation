...
IntPtr CVirt::CybSDK_VirtDevice_FindDevice()
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_FindDevice"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_FindDevice = (_CybSDK_VirtDevice_FindDevice)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
IntPtr CVirt::CybSDK_VirtDevice_CreateDeviceMockupXInput()
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_CreateDeviceMockupXInput"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_CreateDeviceMockupXInput = (_CybSDK_VirtDevice_CreateDeviceMockupXInput)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
bool CVirt::CybSDK_VirtDevice_Open(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		if (DLLCybSDK_VirtDevice_Open == NULL)
		{
			...
			DLLCybSDK_VirtDevice_Open = (_CybSDK_VirtDevice_Open)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
bool CVirt::CybSDK_VirtDevice_IsOpen(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_IsOpen"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_IsOpen = (_CybSDK_VirtDevice_IsOpen)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
bool CVirt::CybSDK_VirtDevice_Close(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		if (DLLCybSDK_VirtDevice_Close == NULL)
		{
			...
			DLLCybSDK_VirtDevice_Close = (_CybSDK_VirtDevice_Close)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
float CVirt::CybSDK_VirtDevice_GetPlayerHeight(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_GetPlayerHeight"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_GetPlayerHeight = (_CybSDK_VirtDevice_GetPlayerHeight)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
void CVirt::CybSDK_VirtDevice_ResetPlayerHeight(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_ResetPlayerHeight"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_ResetPlayerHeight = (_CybSDK_VirtDevice_ResetPlayerHeight)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
float CVirt::CybSDK_VirtDevice_GetPlayerOrientation(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_GetPlayerOrientation"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_GetPlayerOrientation = (_CybSDK_VirtDevice_GetPlayerOrientation)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
float CVirt::CybSDK_VirtDevice_GetMovementSpeed(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_GetMovementSpeed"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_GetMovementSpeed = (_CybSDK_VirtDevice_GetMovementSpeed)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
float CVirt::CybSDK_VirtDevice_GetMovementDirection(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_GetMovementDirection"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_GetMovementDirection = (_CybSDK_VirtDevice_GetMovementDirection)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
...
void CVirt::CybSDK_VirtDevice_ResetPlayerOrientation(IntPtr device)
{
	...
	if (CVirt::DLLHandle != nullptr)
	{
		...
		{
			std::string procName = "CybSDK_VirtDevice_ResetPlayerOrientation"; // The exact name of the DLL function.
			DLLCybSDK_VirtDevice_ResetPlayerOrientation = (_CybSDK_VirtDevice_ResetPlayerOrientation)CVirt::GetDLLProcHandle(procName); // Export the DLL function.
		}
