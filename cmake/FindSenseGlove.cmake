...
#message(">>> Variable {SenseGlove_INCLUDE_DIR}: ${SenseGlove_INCLUDE_DIR}" )

#if(WIN32)
#  find_library(SenseGlove_LIBRARY NAMES SGCore HINTS ${SenseGlove_DIR} NO_DEFAULT_PATH)
#elseif(UNIX)
#  find_library(SenseGlove_LIBRARY  NAMES SGCore.so HINTS ${SenseGlove_DIR} NO_DEFAULT_PATH)
#else()
#  message(FATAL_ERROR  "The Sense Glove SDK is not supported for this operating system.")
#endif()
add_library(SenseGlove SHARED IMPORTED GLOBAL $ENV{SenseGlove_DIR}/Core/SGCoreCpp/lib/linux/Release/libSGCoreCpp.so)
set_target_properties(SenseGlove PROPERTIES IMPORTED_LOCATION $ENV{SenseGlove_DIR}/Core/SGCoreCpp/lib/linux/Release/libSGCoreCpp.so)
