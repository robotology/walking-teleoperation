...
find_file(SRanipalSDK_LIBRARY NAMES SRanipal.dll HINTS ${SRanipal_SDK_DIR}/bin)
find_library(SRanipalSDK_IMPLIB NAMES SRanipal HINTS ${SRanipal_SDK_DIR}/lib)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(SRanipalSDK DEFAULT_MSG
  SRanipalSDK_LIBRARY SRanipalSDK_IMPLIB SRanipalSDK_INCLUDE_DIR)
...
if(SRanipalSDK_FOUND AND NOT TARGET SRanipalSDK::SRanipalSDK)
  ...
  set_target_properties(SRanipalSDK::SRanipalSDK PROPERTIES
    ...
    IMPORTED_IMPLIB ${SRanipalSDK_IMPLIB})

    mark_as_advanced(SRanipalSDK_INCLUDE_DIR SRanipalSDK_LIBRARY SRanipalSDK_IMPLIB)
endif()
